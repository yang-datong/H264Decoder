...
//
////-----------------------------
// int CH264Cabac::get_m_and_n(int32_t ctxIdx, H264_SLIECE_TYPE slice_type,
...
//     const int8_t mn[11][2] = {{20, -15}, {2, 54},  {3, 74},    {20, -15},
...
//   }
//
//   // Table 9-16 – Values of variables m and n for ctxIdx from 54 to 59, and
//   399
//   // to 401
...
//     const int8_t mn[4][3][2] = {{{31, 21}, {31, 31}, {25, 50}},
//                                 {{12, 40}, {11, 51}, {14, 59}},
//                                 {{25, 32}, {21, 49}, {21, 54}},
//                                 {{21, 33}, {19, 50}, {17, 61}}};
//
...
//     const int8_t mn[10][2] = {{0, 41}, {0, 63}, {0, 63},  {0, 63},  {-9, 83},
...
//          {-7, 74},   {-21, 107}, {-27, 127}, {-31, 127}, {-24, 127}, {-18,
//          95},
//          {-27, 127}, {-21, 114}, {-30, 127}, {-17, 123}, {-12, 115}, {-16,
//          122},
//          {-11, 115}, {-12, 63},  {-2, 68},   {-15, 84},  {-13, 104}, {-3,
//          70},
//          {-8, 93},   {-10, 90},  {-30, 127}, {-1, 74},   {-6, 97},   {-7,
//          91},
//          {-20, 127}, {-4, 56},   {-5, 82},   {-7, 76},   {-22, 125}},
//         {{0, 45},    {-4, 78},  {-3, 96},   {-27, 126}, {-28, 98},  {-25,
//         101},
//          {-23, 67},  {-28, 82}, {-20, 94},  {-16, 83},  {-22, 110}, {-21,
//          91},
...
//         96},
//          {-26, 81},  {-35, 98},  {-24, 102}, {-23, 97},  {-27, 119}, {-24,
//          99},
//          {-21, 110}, {-18, 102}, {-36, 127}, {0, 80},    {-5, 89},   {-7,
//          94},
//          {-4, 92},   {0, 39},    {0, 65},    {-15, 84},  {-35, 127}, {-2,
//          73},
//          {-12, 104}, {-9, 91},   {-31, 127}, {3, 55},    {7, 56},    {7, 55},
//          {8, 61},    {-3, 53},   {0, 68},    {-7, 74},   {-9, 88}},
//         {{7, 34},    {-9, 88},  {-20, 127}, {-36, 127}, {-17, 91},  {-14,
//         95},
//          {-25, 84},  {-25, 86}, {-12, 89},  {-17, 91},  {-31, 127}, {-14,
//          76},
...
//
//     if (slice_type == H264_SLIECE_TYPE_I || slice_type ==
//     H264_SLIECE_TYPE_SI) {
//       m = mn[0][ctxIdx - 70][0];
//       n = mn[0][ctxIdx - 70][1];
//     } else {
...
//          {1, 51},    {7, 50},    {28, 19},  {16, 33},   {14, 62},  {-13,
//          108},
//          {-15, 100}, {-13, 101}, {-13, 91}, {-12, 94},  {-10, 88}, {-16, 84},
//          {-10, 86},  {-7, 83},   {-13, 87}, {-19, 94},  {1, 70},   {0, 72},
//          {-5, 74},   {18, 59},   {-8, 102}, {-15, 100}, {0, 95},   {-4, 75},
//          {2, 72},    {-11, 75},  {-3, 71},  {15, 46},   {-13, 69}, {0, 62},
//          {0, 65},    {21, 37},   {-15, 72}, {9, 57},    {16, 54},  {0, 62},
//          {12, 72}},
//         {{-2, 85},  {-6, 78}, {-1, 75},  {-7, 77}, {2, 54},  {5, 50},  {-3,
//         68},
//          {1, 50},   {6, 42},  {-4, 81},  {1, 63},  {-4, 70}, {0, 67},  {2,
//          57},
//          {-2, 76},  {11, 35}, {4, 64},   {1, 61},  {11, 35}, {18, 25}, {12,
//          24}, {13, 29},  {13, 36}, {-10, 93}, {-7, 73}, {-2, 73}, {13, 46},
//          {9, 49},
//          {-7, 100}, {9, 53},  {2, 53},   {5, 53},  {-2, 61}, {0, 56},  {0,
//          56},
//          {-13, 63}, {-5, 60}, {-1, 62},  {4, 57},  {-6, 69}, {4, 57},  {14,
//          39}, {4, 51},   {13, 68}, {3, 64},   {1, 61},  {9, 63},  {7, 50},
//          {16, 39}, {5, 44},   {4, 52},  {11, 48},  {-5, 60}, {-1, 59}, {0,
//          59},  {22, 33}, {5, 44},   {14, 43}, {-1, 78},  {0, 60},  {9, 69}},
//         {{-13, 103}, {-13, 91},  {-9, 89},   {-14, 92},  {-8, 76},   {-12,
//         87},
//          {-23, 110}, {-24, 105}, {-10, 78},  {-20, 112}, {-17, 99},  {-78,
//          127},
//          {-70, 127}, {-50, 127}, {-46, 127}, {-4, 66},   {-5, 78},   {-4,
//          71},
//          {-8, 72},   {2, 59},    {-1, 55},   {-7, 70},   {-6, 75},   {-8,
//          89},
//          {-34, 119}, {-3, 75},   {32, 20},   {30, 22},   {-44, 127}, {0, 54},
//          {-5, 61},   {0, 58},    {-1, 60},   {-3, 61},   {-8, 67},   {-25,
//          84},
//          {-14, 74},  {-5, 65},   {5, 52},    {2, 57},    {0, 61},    {-9,
//          69},
//          {-11, 70},  {18, 55},   {-4, 71},   {0, 58},    {7, 61},    {9, 41},
//          {18, 25},   {9, 32},    {5, 43},    {9, 47},    {0, 44},    {0, 51},
//          {2, 46},    {19, 38},   {-4, 66},   {15, 38},   {12, 42},   {9, 34},
//          {0, 89}},
...
//          {-2, 27},  {13, 91},  {3, 65},    {-7, 69},  {8, 77},   {-10, 66},
//          {3, 62},   {-3, 68},  {-20, 81},  {0, 30},   {1, 7},    {-3, 23},
//          {-21, 74}, {16, 66},  {-23, 124}, {17, 37},  {44, -18}, {50, -34},
//          {-22, 127}}};
//
//     if (slice_type == H264_SLIECE_TYPE_I || slice_type ==
//     H264_SLIECE_TYPE_SI) {
...
//          {35, 16},  {39, 22},  {14, 48},  {27, 37},  {21, 60},  {12, 68},
//          {2, 97}},
//         {{11, 28}, {2, 40},  {3, 44},  {0, 49},  {0, 46},  {2, 44},  {2, 51},
//          {0, 47},  {4, 39},  {2, 62},  {6, 46},  {0, 54},  {3, 54},  {2, 58},
//          {4, 63},  {6, 51},  {6, 57},  {7, 53},  {6, 52},  {6, 55},  {11,
//          45}, {14, 36}, {8, 53},  {-1, 82}, {7, 55},  {-3, 78}, {15, 46},
//          {22, 31},
//          {-1, 84}, {25, 7},  {30, -7}, {28, 3},  {28, 4},  {32, 0},  {34,
//          -1}, {30, 6},  {30, 6},  {32, 9},  {31, 19}, {26, 27}, {26, 30},
//          {37, 20}, {28, 34}, {17, 70}, {1, 67},  {5, 59},  {9, 67},  {16,
//          30}, {18, 32}, {18, 35}, {22, 29}, {24, 31}, {23, 38}, {18, 43},
//          {20, 41}, {11, 63}, {9, 59},  {9, 64},  {-1, 94}, {-2, 89}, {-9,
//          108}},
...
//         {{-3, 71},  {-6, 42},  {-5, 50},   {-3, 54},  {-2, 62},  {0, 58},
//          {1, 63},   {-2, 72},  {-1, 74},   {-9, 91},  {-5, 67},  {-5, 27},
//          {-3, 39},  {-2, 44},  {0, 46},    {-16, 64}, {-8, 68},  {-10, 78},
//          {-6, 77},  {-10, 86}, {-12, 92},  {-15, 55}, {-10, 60}, {-6, 62},
//          {-4, 65},  {-12, 73}, {-8, 76},   {-7, 80},  {-9, 88},  {-17, 110},
//          {-11, 97}, {-20, 84}, {-11, 79},  {-6, 73},  {-4, 74},  {-13, 86},
//          {-13, 96}, {-11, 97}, {-19, 117}, {-8, 78},  {-5, 33},  {-4, 48},
//          {-2, 53},  {-3, 62},  {-13, 71},  {-10, 79}, {-12, 86}, {-13, 90},
//          {-14, 97}},
//         {{-6, 76},  {-2, 44},   {0, 45},   {0, 52},    {-3, 64}, {-2, 59},
//          {-4, 70},  {-4, 75},   {-8, 82},  {-17, 102}, {-9, 77}, {3, 24},
//          {0, 42},   {0, 48},    {0, 55},   {-6, 59},   {-7, 71}, {-12, 83},
//          {-11, 87}, {-30, 119}, {1, 58},   {-3, 29},   {-1, 36}, {1, 38},
//          {2, 43},   {-6, 55},   {0, 58},   {0, 64},    {-3, 74}, {-10, 90},
//          {0, 70},   {-4, 29},   {5, 31},   {7, 42},    {1, 59},  {-2, 58},
//          {-3, 72},  {-3, 81},   {-11, 97}, {0, 58},    {8, 5},   {10, 14},
//          {14, 18},  {13, 27},   {2, 40},   {0, 58},    {-3, 70}, {-6, 79},
//          {-8, 85}},
//         {{-23, 112}, {-15, 71},  {-7, 61},  {0, 53},    {-5, 66},   {-11,
//         77},
//          {-9, 80},   {-9, 84},   {-10, 87}, {-34, 127}, {-21, 101}, {-3, 39},
//          {-5, 53},   {-7, 61},   {-11, 75}, {-15, 77},  {-17, 91},  {-25,
//          107},
//          {-25, 111}, {-28, 122}, {-11, 76}, {-10, 44},  {-10, 52},  {-10,
//          57},
//          {-9, 58},   {-16, 72},  {-7, 69},  {-4, 69},   {-5, 74},   {-9, 86},
//          {2, 66},    {-9, 34},   {1, 32},   {11, 31},   {5, 52},    {-2, 55},
//          {-2, 67},   {0, 73},    {-8, 89},  {3, 52},    {7, 4},     {10, 8},
//          {17, 8},    {16, 19},   {3, 37},   {-1, 61},   {-5, 73},   {-1, 70},
//          {-4, 78}},
//         {{-24, 115}, {-22, 82},  {-9, 62},  {0, 53},    {0, 59},    {-14,
//         85},
//          {-13, 89},  {-13, 94},  {-11, 92}, {-29, 127}, {-21, 100}, {-14,
//          57},
//          {-12, 67},  {-11, 71},  {-10, 77}, {-21, 85},  {-16, 88},  {-23,
//          104},
//          {-15, 98},  {-37, 127}, {-10, 82}, {-8, 48},   {-8, 61},   {-8, 66},
//          {-7, 70},   {-14, 75},  {-10, 79}, {-9, 83},   {-12, 92},  {-18,
//          108},
//          {-4, 79},   {-22, 69},  {-16, 75}, {-2, 58},   {1, 58},    {-13,
//          78},
//          {-9, 83},   {-4, 81},   {-13, 99}, {-13, 81},  {-6, 38},   {-13,
//          62},
//          {-6, 58},   {-2, 59},   {-16, 73}, {-10, 76},  {-13, 86},  {-9, 83},
//          {-10, 87}}};
//
//     if (slice_type == H264_SLIECE_TYPE_I || slice_type ==
//     H264_SLIECE_TYPE_SI) {
...
//          {-1, 76},  {-1, 83},  {-7, 99},  {-14, 95}, {2, 95},  {0, 76},
//          {-5, 74},  {0, 70},   {-11, 75}, {1, 68},   {0, 65},  {-14, 73},
//          {3, 62},   {4, 62},   {-1, 68},  {-13, 75}, {11, 55}, {5, 64},
//          {12, 70}},
//         {{-13, 106}, {-16, 106}, {-10, 87},  {-21, 114}, {-18, 110}, {-14,
//         98},
//          {-22, 110}, {-21, 106}, {-18, 103}, {-21, 107}, {-23, 108}, {-26,
//          112},
//          {-10, 96},  {-12, 95},  {-5, 91},   {-9, 93},   {-22, 94},  {-5,
//          86}, {9, 67},    {-4, 80},   {-10, 85},  {-1, 70},   {7, 60},    {9,
//          58}, {5, 61},    {12, 50},   {15, 50},   {18, 49},   {17, 54}, {10,
//          41}, {7, 46},    {-1, 51},   {7, 49},    {8, 52},    {9, 41},    {6,
//          47}, {2, 55},    {13, 41},   {10, 44},   {6, 50},    {5, 53}, {13,
//          49}, {4, 63},    {6, 64},    {-2, 69},   {-2, 59},   {6, 70}, {10,
//          44}, {9, 31},    {12, 43},   {3, 53},    {14, 34},   {10, 38}, {-3,
//          52}, {13, 40},   {17, 32},   {7, 44},    {7, 38},    {13, 50}, {10,
//          57}, {26, 43}},
//         {{-21, 126}, {-23, 124}, {-20, 110}, {-26, 126}, {-25, 124}, {-17,
//         105},
//          {-27, 121}, {-27, 117}, {-17, 102}, {-26, 117}, {-27, 116}, {-33,
//          122},
//          {-10, 95},  {-14, 100}, {-8, 95},   {-17, 111}, {-28, 114}, {-6,
//          89},
//          {-2, 80},   {-4, 82},   {-9, 85},   {-8, 81},   {-1, 72},   {5, 64},
//          {1, 67},    {9, 56},    {0, 69},    {1, 69},    {7, 69},    {-7,
//          69},
//          {-6, 67},   {-16, 77},  {-2, 64},   {2, 61},    {-6, 67},   {-3,
//          64}, {2, 57},    {-3, 65},   {-3, 66},   {0, 62},    {9, 51}, {-1,
//          66},
//          {-2, 71},   {-2, 75},   {-1, 70},   {-9, 72},   {14, 60},   {16,
//          37}, {0, 47},    {18, 35},   {11, 37},   {12, 41},   {10, 41},   {2,
//          48}, {12, 41},   {13, 41},   {0, 59},    {3, 50},    {19, 40},   {3,
//          66}, {18, 50}},
//         {{-22, 127}, {-25, 127}, {-25, 120}, {-27, 127}, {-19, 114}, {-23,
//         117},
//          {-25, 118}, {-26, 117}, {-24, 113}, {-28, 118}, {-31, 120}, {-37,
//          124},
//          {-10, 94},  {-15, 102}, {-10, 99},  {-13, 106}, {-50, 127}, {-5,
//          92}, {17, 57},   {-5, 86},   {-13, 94},  {-12, 91},  {-2, 77},   {0,
//          71},
//          {-1, 73},   {4, 64},    {-7, 81},   {5, 64},    {15, 57},   {1, 67},
//          {0, 68},    {-10, 67},  {1, 68},    {0, 77},    {2, 64},    {0, 68},
//          {-5, 78},   {7, 55},    {5, 59},    {2, 65},    {14, 54},   {15,
//          44}, {5, 60},    {2, 70},    {-2, 76},   {-18, 86},  {12, 70},   {5,
//          64},
//          {-12, 70},  {11, 55},   {5, 56},    {0, 69},    {2, 65},    {-6,
//          74}, {5, 54},    {7, 54},    {-6, 76},   {-11, 82},  {-2, 77}, {-2,
//          77}, {25, 42}}};
//
//     if (slice_type == H264_SLIECE_TYPE_I || slice_type ==
//     H264_SLIECE_TYPE_SI) {
...
//          {23, 35},  {13, 58},  {29, -3},  {26, 0},   {22, 30},   {31, -7},
//          {35, -15}, {34, -3},  {34, 3},   {36, -1},  {34, 5},    {32, 11},
//          {35, 5},   {34, 12},  {39, 11},  {30, 29},  {34, 26},   {29, 39},
//          {19, 66}},
...
//          {16, 65},  {14, 71},  {8, 60},   {6, 63},   {17, 65},   {21, 24},
//          {23, 20},  {26, 23},  {27, 32},  {28, 23},  {28, 24},   {23, 40},
//          {24, 32},  {28, 29},  {23, 42},  {19, 57},  {22, 53},   {22, 61},
//          {11, 86}},
...
//          {29, 30},  {25, 44},  {12, 48},  {11, 49},  {26, 45},  {22, 22},
//          {23, 22},  {27, 21},  {33, 20},  {26, 28},  {30, 24},  {27, 34},
//          {18, 42},  {25, 39},  {18, 50},  {12, 70},  {21, 54},  {14, 71},
//          {11, 83}},
...
//          {27, 47},  {21, 62},  {18, 31},  {19, 26},   {36, 24},  {24, 23},
//          {27, 16},  {24, 30},  {31, 29},  {22, 41},   {22, 42},  {16, 60},
//          {15, 52},  {14, 60},  {3, 78},   {-16, 123}, {21, 53},  {22, 56},
//          {25, 61}}};
//
//     if (slice_type == H264_SLIECE_TYPE_I || slice_type ==
//     H264_SLIECE_TYPE_SI) {
...
//         {{-17, 120}, {-20, 112}, {-18, 114}, {-11, 85}, {-15, 92},  {-14,
//         89},
//          {-26, 71},  {-15, 81},  {-14, 80},  {0, 68},   {-14, 70},  {-24,
//          56},
//          {-23, 68},  {-24, 50},  {-11, 74},  {23, -13}, {26, -13},  {40,
//          -15}, {49, -14},  {44, 3},    {45, 6},    {44, 34},  {33, 54}, {19,
//          82},
//          {-3, 75},   {-1, 23},   {1, 34},    {1, 43},   {0, 54},    {-2, 55},
//          {0, 61},    {1, 64},    {0, 68},    {-9, 92},  {-14, 106}, {-13,
//          97},
//          {-15, 90},  {-12, 90},  {-18, 88},  {-10, 73}, {-9, 79},   {-14,
//          86},
...
//          {-15, 84},  {-13, 104}, {-3, 70},   {-8, 93},   {-10, 90}, {-30,
//          127},
//          {-17, 123}, {-12, 115}, {-16, 122}, {-11, 115}, {-12, 63}, {-2, 68},
//          {-15, 84},  {-13, 104}, {-3, 70},   {-8, 93},   {-10, 90}, {-30,
//          127}},
//         {{-7, 92}, {-5, 89}, {-7, 96}, {-13, 108}, {-3, 46}, {-1, 65},
//          {-1, 57}, {-9, 93}, {-3, 74}, {-9, 92},   {-8, 87}, {-23, 126},
//          {-7, 92}, {-5, 89}, {-7, 96}, {-13, 108}, {-3, 46}, {-1, 65},
//          {-1, 57}, {-9, 93}, {-3, 74}, {-9, 92},   {-8, 87}, {-23, 126}},
//         {{0, 80},   {-5, 89},   {-7, 94}, {-4, 92},   {0, 39},  {0, 65},
//          {-15, 84}, {-35, 127}, {-2, 73}, {-12, 104}, {-9, 91}, {-31, 127},
//          {0, 80},   {-5, 89},   {-7, 94}, {-4, 92},   {0, 39},  {0, 65},
//          {-15, 84}, {-35, 127}, {-2, 73}, {-12, 104}, {-9, 91}, {-31, 127}},
//         {{11, 80},  {5, 76},    {2, 84},  {5, 78},    {-6, 55},  {4, 61},
//          {-14, 83}, {-37, 127}, {-5, 79}, {-11, 104}, {-11, 91}, {-30, 127},
//          {11, 80},  {5, 76},    {2, 84},  {5, 78},    {-6, 55},  {4, 61},
//          {-14, 83}, {-37, 127}, {-5, 79}, {-11, 104}, {-11, 91}, {-30,
//          127}}};
//
//     if (slice_type == H264_SLIECE_TYPE_I || slice_type ==
//     H264_SLIECE_TYPE_SI) {
...
//          {1, 51},    {7, 50},    {28, 19},   {16, 33},   {14, 62},  {-13,
//          108},
//          {-15, 100}, {-13, 101}, {-13, 91},  {-12, 94},  {-10, 88}, {-16,
//          84},
//          {-10, 86},  {-7, 83},   {-13, 87},  {-19, 94},  {1, 70},   {0, 72},
//          {-5, 74},   {18, 59},   {-7, 93},   {-11, 87},  {-3, 77},  {-5, 71},
//          {-4, 63},   {-4, 68},   {-12, 84},  {-7, 62},   {-7, 65},  {8, 61},
//          {5, 56},    {-2, 66},   {1, 64},    {0, 61},    {-2, 78},  {1, 50},
//          {7, 52},    {10, 35},   {0, 44},    {11, 38},   {1, 45},   {0, 46},
//          {5, 44},    {31, 17},   {1, 51},    {7, 50},    {28, 19},  {16, 33},
//          {14, 62},   {-13, 108}, {-15, 100}, {-13, 101}, {-13, 91}, {-12,
//          94},
//          {-10, 88},  {-16, 84},  {-10, 86},  {-7, 83},   {-13, 87}, {-19,
...
//          {4, 51},   {13, 68},  {-2, 85}, {-6, 78}, {-1, 75},  {-7, 77},
...
//          {-14, 74},  {-5, 65},   {5, 52},    {2, 57},    {0, 61},    {-9,
//          69},
//          {-11, 70},  {18, 55},   {-13, 103}, {-13, 91},  {-9, 89},   {-14,
//          92},
//          {-8, 76},   {-12, 87},  {-23, 110}, {-24, 105}, {-10, 78},  {-20,
//          112},
//          {-17, 99},  {-78, 127}, {-70, 127}, {-50, 127}, {-46, 127}, {-4,
//          66},
//          {-5, 78},   {-4, 71},   {-8, 72},   {2, 59},    {-1, 55},   {-7,
//          70},
//          {-6, 75},   {-8, 89},   {-34, 119}, {-3, 75},   {32, 20},   {30,
//          22},
//          {-44, 127}, {0, 54},    {-5, 61},   {0, 58},    {-1, 60},   {-3,
//          61},
...
//          {-15, 72}, {-5, 75},  {-8, 80},  {-21, 83}, {-21, 64}, {-13, 31},
//          {-25, 64}, {-29, 94}, {9, 75},   {17, 63},  {-8, 74},  {-5, 35},
//          {-2, 27},  {13, 91},  {-4, 86},  {-12, 88}, {-5, 82},  {-3, 72},
...
//          {22, -17}, {26, -17}, {30, -25}, {28, -20}, {33, -23}, {37, -27},
//          {33, -23}, {40, -28}, {38, -17}, {33, -11}, {40, -15}, {41, -6},
//          {38, 1},   {41, 17},  {24, 0},   {15, 9},   {8, 25},   {13, 18},
...
//          {-1, 84}, {25, 7},  {30, -7}, {28, 3},  {28, 4},  {32, 0},  {34,
//          -1}, {30, 6},  {30, 6},  {32, 9},  {31, 19}, {26, 27}, {26, 30},
//          {37, 20}, {28, 34}, {17, 70}, {11, 28}, {2, 40},  {3, 44},  {0, 49},
//          {0, 46}, {2, 44},  {2, 51},  {0, 47},  {4, 39},  {2, 62},  {6, 46},
//          {0, 54}, {3, 54},  {2, 58},  {4, 63},  {6, 51},  {6, 57},  {7, 53},
//          {6, 52}, {6, 55},  {11, 45}, {14, 36}, {8, 53},  {-1, 82}, {7, 55},
//          {-3, 78}, {15, 46}, {22, 31}, {-1, 84}, {25, 7},  {30, -7}, {28, 3},
//          {28, 4}, {32, 0},  {34, -1}, {30, 6},  {30, 6},  {32, 9},  {31, 19},
...
//          {34, -30},  {36, -28}, {38, -28},  {38, -27}, {34, -18}, {35, -16},
//          {34, -14},  {32, -8},  {37, -6},   {35, 0},   {30, 10},  {28, 18},
//          {26, 25},   {29, 41},  {4, 45},    {10, 28},  {10, 31},  {33, -11},
...
//          {33, -25}, {28, -3},  {24, 10},  {27, 0},  {34, -14}, {52, -44},
//          {39, -24}, {19, 17},  {31, 25},  {36, 29}, {24, 33},  {34, 15},
//          {30, 20},  {22, 73},  {4, 39},   {0, 42},  {7, 34},   {11, 29},
...
//          {-26, 71},  {-15, 81},  {-14, 80},  {0, 68},    {-14, 70}, {-24,
//          56},
//          {-23, 68},  {-24, 50},  {-11, 74},  {-14, 106}, {-13, 97}, {-15,
//          90},
//          {-12, 90},  {-18, 88},  {-10, 73},  {-9, 79},   {-14, 86}, {-10,
//          73},
...
//          41}, {7, 46},    {-1, 51},   {7, 49},    {8, 52},    {9, 41},    {6,
//          47}, {2, 55},    {13, 41},   {10, 44},   {6, 50},    {5, 53}, {13,
//          49}, {4, 63},    {6, 64},    {-13, 106}, {-16, 106}, {-10, 87},
//          {-21, 114},
//          {-18, 110}, {-14, 98},  {-22, 110}, {-21, 106}, {-18, 103}, {-21,
//          107},
//          {-23, 108}, {-26, 112}, {-10, 96},  {-12, 95},  {-5, 91},   {-9,
//          93},
//          {-22, 94},  {-5, 86},   {9, 67},    {-4, 80},   {-10, 85},  {-1,
//          70}, {7, 60},    {9, 58},    {5, 61},    {12, 50},   {15, 50}, {18,
//          49}, {17, 54},   {10, 41},   {7, 46},    {-1, 51},   {7, 49},    {8,
//          52}, {9, 41},    {6, 47},    {2, 55},    {13, 41},   {10, 44},   {6,
...
//          64}, {2, 57},    {-3, 65},   {-3, 66},   {0, 62},    {9, 51}, {-1,
//          66},
//          {-2, 71},   {-2, 75},   {-21, 126}, {-23, 124}, {-20, 110}, {-26,
//          126},
//          {-25, 124}, {-17, 105}, {-27, 121}, {-27, 117}, {-17, 102}, {-26,
//          117},
//          {-27, 116}, {-33, 122}, {-10, 95},  {-14, 100}, {-8, 95},   {-17,
//          111},
//          {-28, 114}, {-6, 89},   {-2, 80},   {-4, 82},   {-9, 85},   {-8,
//          81},
...
//          {0, 68},    {-10, 67},  {1, 68},    {0, 77},    {2, 64},    {0, 68},
//          {-5, 78},   {7, 55},    {5, 59},    {2, 65},    {14, 54},   {15,
//          44}, {5, 60},    {2, 70},    {-22, 127}, {-25, 127}, {-25, 120},
//          {-27, 127},
//          {-19, 114}, {-23, 117}, {-25, 118}, {-26, 117}, {-24, 113}, {-28,
//          118},
//          {-31, 120}, {-37, 124}, {-10, 94},  {-15, 102}, {-10, 99},  {-13,
//          106},
//          {-50, 127}, {-5, 92},   {17, 57},   {-5, 86},   {-13, 94},  {-12,
//          91},
...
//     }
//   } else if (ctxIdx == 276) {
//     return -1; // ctxIdx = 276 is assigned to the binIdx of mb_type
//     indicating
//                // the I_PCM mode.
//   } else {
...
// int CH264Cabac::Initialisation_process_for_context_variables(
//     H264_SLIECE_TYPE slice_type, int32_t cabac_init_idc, int32_t SliceQPY) {
//   int ret = 0;
//
//   int32_t m = 0;
//   int32_t n = 0;
//
//   // The possible values of the context index ctxIdx are in the range 0 to
//   1023,
//   // inclusive.
...
//// This process is invoked before decoding the first macroblock of a slice or
//// after the decoding of any pcm_alignment_zero_bit and all pcm_sample_luma
///and / pcm_sample_chroma data for a macroblock of type I_PCM.
// int CH264Cabac::Initialisation_process_for_the_arithmetic_decoding_engine(
//     BitStream &bs) {
//   m_codIRange = 510; // 510 = 0x01FE
//
//   m_codIOffset = bs.readUn(9); // read_bits(9);
//
//   return 0;
// }
//
...
//   int ret = 0;
//
//   // When MbaffFrameFlag is equal to 1 and mb_field_decoding_flag has not
//   been
//   // decoded (yet) for the current macroblock pair with top macroblock
//   address 2
...
//       picture.m_h264_slice_header.MbaffFrameFlag, _CurrMbAddr, mbAddrA,
//       mbAddrB, isChroma);
...
//   int32_t mbAddrD = 0;
//
//   // 6.4.10 Derivation process for neighbouring macroblock addresses and
//   their
...
//
//   // When both macroblocks mbAddrN and mbAddrN + 1 have mb_type equal to
//   P_Skip
//   // or B_Skip, the inference rule for the syntax element
//   mb_field_decoding_flag
...
// int
// CH264Cabac::Derivation_process_of_ctxIdxInc_for_the_syntax_element_mb_type(
...
//   // 6.4.11.1 Derivation process for neighbouring macroblocks
//   ret = picture.Derivation_process_for_neighbouring_macroblocks(
//       picture.m_h264_slice_header.MbaffFrameFlag, picture.CurrMbAddr,
...
//              0 // FIXME: the prior decoded bin value bk of
//              coded_block_pattern
...
//
//   // When the current macroblock is the first macroblock of a slice,
//   prevMbAddr
...
//   *
//                                (1 +
//                                picture.m_h264_slice_header.MbaffFrameFlag);
...
//     xS = InverseRasterScan(subMbPartIdx, SubMbPartWidth, SubMbPartHeight, 8,
//     0); yS = InverseRasterScan(subMbPartIdx, SubMbPartWidth, SubMbPartHeight,
//     8, 1);
//
...
//       x + xS - 1, y + yS + 0, mbPartIdx, currSubMbType, subMbPartIdx,
//       isChroma, mbAddrN_A, mbPartIdxN_A, subMbPartIdxN_A);
//   RETURN_IF_FAILED(ret != 0, ret);
//
//   ret = picture.Derivation_process_for_neighbouring_partitions(
//       x + xS + 0, y + yS - 1, mbPartIdx, currSubMbType, subMbPartIdx,
//       isChroma, mbAddrN_B, mbPartIdxN_B, subMbPartIdxN_B);
//   RETURN_IF_FAILED(ret != 0, ret);
//
//   //--------------------------------
...
//
//       ret = CH264MacroBlock::SubMbPredModeFunc(
...
//
//       ret = CH264MacroBlock::MbPartPredMode2(
...
//     // macroblock is a frame macroblock, and the macroblock mbAddrN is a
//     field
//     // macroblock,
...
//     ctxIdxInc = 2;
//   } else // if ( (absMvdCompA + absMvdCompB ) >= 3 && (absMvdCompA +
//   absMvdCompB
//          // ) <= 32)
//   {
//     ctxIdxInc = 1;
...
//     RETURN_IF_FAILED(ret != 0, ret);
//
//     // 1. If ctxBlockCat is equal to 0, the luma DC block of macroblock
//     mbAddrN
//     // is assigned to transBlockN.
//     // 2. Otherwise, if ctxBlockCat is equal to 6, the Cb DC block of
//     macroblock
//     // mbAddrN is assigned to transBlockN.
//     // 3. Otherwise (ctxBlockCat is equal to 10), the Cr DC block of
//     macroblock
//     // mbAddrN is assigned to transBlockN.
//
//     //----------A------------
...
//         chroma4x4BlkIdx, mbAddrA, mbAddrB, chroma4x4BlkIdxA,
//         chroma4x4BlkIdxB);
//     RETURN_IF_FAILED(ret != 0, ret);
//
//     //----------A------------
...
//         picture.m_mbs[mbAddrA].m_name_of_mb_type != B_Skip &&
//         picture.m_mbs[mbAddrA].m_name_of_mb_type != I_PCM &&
//         ((picture.m_mbs[mbAddrA].CodedBlockPatternLuma >> (cb4x4BlkIdxA >>
//         2)) &
//          1) != 0 &&
//         picture.m_mbs[mbAddrA].transform_size_8x8_flag == 0) {
//       transBlockA = 1;
...
//         picture.m_mbs[mbAddrB].m_name_of_mb_type != B_Skip &&
//         picture.m_mbs[mbAddrB].m_name_of_mb_type != I_PCM &&
//         ((picture.m_mbs[mbAddrB].CodedBlockPatternLuma >> (cb4x4BlkIdxB >>
//         2)) &
//          1) != 0 &&
//         picture.m_mbs[mbAddrB].transform_size_8x8_flag == 0) {
//       transBlockB = 1;
...
//         picture.m_mbs[mbAddrA].m_name_of_mb_type != B_Skip &&
//         picture.m_mbs[mbAddrA].m_name_of_mb_type != I_PCM &&
//         ((picture.m_mbs[mbAddrA].CodedBlockPatternLuma >> (cr4x4BlkIdxA >>
//         2)) &
//          1) != 0 &&
//         picture.m_mbs[mbAddrA].transform_size_8x8_flag == 0) {
//       transBlockA = 1;
...
//         picture.m_mbs[mbAddrB].m_name_of_mb_type != B_Skip &&
//         picture.m_mbs[mbAddrB].m_name_of_mb_type != I_PCM &&
//         ((picture.m_mbs[mbAddrB].CodedBlockPatternLuma >> (cr4x4BlkIdxB >>
//         2)) &
//          1) != 0 &&
//         picture.m_mbs[mbAddrB].transform_size_8x8_flag == 0) {
//       transBlockB = 1;
...
// int CH264Cabac::DecodeDecision(BitStream &bs, int32_t ctxIdx, int32_t
// &binVal) {
//   int ret = 0;
//
...
//     codIOffset = codIOffset | bs.readU1();
//   }
//
//   return 0;
// }
...
//     synElVal); RETURN_IF_FAILED(ret != 0, -1);
...
//         ctxIdx = ctxIdxOffset + ((ctxIdxOffset == 3) ? 4 : 2);
//         ret =
//             DecodeBin(bs, bypassFlag, ctxIdx, binVal); // binIdx = 3;
//             b3=binVal;
//         RETURN_IF_FAILED(ret != 0, -1);
//
...
//
//   if (binVal == 0) // For the syntax element value for which b0 is equal to
//   0,
...
//     synElVal); RETURN_IF_FAILED(ret != 0, -1);
//
//     // the suffix bit string as specified in Table 9-36 for macroblock type
//     in I
//     // slices indexed by subtracting 1 from the value of mb_type in SI
//     slices. synElVal += 1;
//   }
//
//   return 0;
...
//   int32_t bypassFlag = 0;
//
//   RETURN_IF_FAILED((slice_type % 5) != H264_SLIECE_TYPE_P &&
//                        (slice_type % 5) != H264_SLIECE_TYPE_SP,
//                    -1);
//
...
//     ret = DecodeBin(bs, bypassFlag, ctxIdx, binVal); // binIdx = 1;
//     b1=binVal; RETURN_IF_FAILED(ret != 0, -1);
//
...
//     synElVal); RETURN_IF_FAILED(ret != 0, -1);
//
//     // The bin string for I macroblock types in P and SP slices corresponding
//     to
//     // mb_type values 5 to 30 consists of a concatenation of a prefix, which
//     // consists of a single bit with value equal to 1 as specified in Table
//     9-37
...
//               ctxIdxOffset = 32;
//
//               ret = CABAC_decode_mb_type_in_I_slices(picture, bs,
//               ctxIdxOffset,
//                                                      synElVal);
//               RETURN_IF_FAILED(ret != 0, -1);
//
...
//               // concatenation of a prefix bit string as specified in Table
//               9-37
//               // and suffix bit strings as specified in Table 9-36, indexed
//               by
...
//
////-------------------------------------------
// int CH264Cabac::CABAC_decode_mb_skip_flag(PictureBase &picture, BitStream
// &bs,
//                                           int32_t _CurrMbAddr,
//                                           int32_t &synElVal) {
//   int ret = 0;
...
//   // FL binarization is constructed by using a fixedLength-bit unsigned
//   integer
//   // bin string of the syntax element value, where fixedLength = Ceil( Log2(
//   // cMax + 1 ) ). The indexing of bins for the FL binarization is such that
//   the
//   // binIdx = 0 relates to the least significant bit with increasing values
//   of
...
//   // bit string. The prefix of the binarization is specified by invoking the
//   TU
//   // binarization process for the prefix part Min( uCoff, Abs( synElVal ) )
//   of a
...
//
//   // 9.3.3.1.1.7 Derivation process of ctxIdxInc for the syntax elements
//   mvd_l0
//   // and mvd_l1
//   int32_t is_mvd_10 = (mvd_flag == 0 || mvd_flag == 1) ? 1 : 0;
//   ret =
//       Derivation_process_of_ctxIdxInc_for_the_syntax_elements_mvd_l0_and_mvd_l1(
//           picture, is_mvd_10, mbPartIdx, subMbPartIdx, isChroma,
//           ctxIdxOffset, ctxIdxInc);
//   RETURN_IF_FAILED(ret != 0, ret);
//
//   //---------------注意是：UEG3------------------------
//   // UEG3编码是由 prefix(TU binarization) + suffix(Exp-Golomb) +
//   signedValFlag,
//   // 三部分组成
//
//   //-----1. 先解码前缀(TU)--------
...
//   RETURN_IF_FAILED(ret != 0, -1);
//
//   // If one of the following is true, the bin string of a syntax element
//   having
//   // value synElVal consists only of a prefix bit string:
//   //  – signedValFlag is equal to 0 and the prefix bit string is not equal to
//   //  the bit string of length uCoff with all bits equal to 1, –
//   signedValFlag
...
//     synElVal = 1;
//     ctxIdx =
//         ctxIdxOffset + 3; // ctxIdxOffset + ctxIdxInc = 40(47) + 3; //Table
//         9-39
//
//     // TU, cMax=uCoff=9;
...
//                                         int32_t ref_idx_flag, int32_t
//                                         mbPartIdx, int32_t &synElVal) {
//   int ret = 0;
//
//   int32_t maxBinIdxCtx = 0;
//   int32_t ctxIdxOffset = 0;
...
//     {
//       ret = DecodeBin(bs, bypassFlag, ctxIdx, binVal); // binIdx =
//       2,3,4.,..,k; RETURN_IF_FAILED(ret != 0, -1);
//
//       binIdx++;
//
...
//   // mapped value of the syntax element mb_qp_delta, where the assignment
//   rule
...
//         // the syntax element value equal to cMax the bin string is a bit
//         string
...
//
// int
// CH264Cabac::CABAC_decode_rem_intra4x4_pred_mode_or_rem_intra8x8_pred_mode(
//     PictureBase &picture, BitStream &bs, int32_t &synElVal) {
//   int ret = 0;
//
//   int32_t maxBinIdxCtx = 0;
...
//   picture.m_h264_slice_header.m_sps.ChromaArrayType; int32_t maxBinIdxCtx =
//   0; int32_t ctxIdxOffset = 0; int32_t ctxIdxInc = 0; int32_t binIdx = -1;
//   int32_t binVal = 0;
//   int32_t binValues = 0;
//   int32_t ctxIdx = 0;
//   int32_t bypassFlag = 0;
...
//   // coeff_abs_level_minus1
//
//   // The binarization of coded_block_pattern consists of a prefix part and
//   (when
//   // present) a suffix part. The prefix part of the binarization is given by
//   the
...
//   // consists of the TU binarization of CodedBlockPatternChroma with cMax
//   = 2.
...
//                                               BitStream &bs,
//                                               MB_RESIDUAL_LEVEL
//                                               mb_block_level, int32_t BlkIdx,
//                                               int32_t iCbCr, int32_t
//                                               &synElVal) {
//   int ret = 0;
//
...
//
//   //--------3.计算出ctxIdx的值-----------
//   // the ctxIdx is specified to be the sum of the following terms:
//   ctxIdxOffset
...
//   // levelListIdx be set equal to the index of the list of transform
//   coefficient
...
//       ctxBlockCat != 13) {
//     // RETURN_IF_FAILED(levelListIdx < 0 || levelListIdx > maxNumCoeff - 2,
//     -1);
//
//     ctxIdxInc = levelListIdx; // levelListIdx ranges from 0 to maxNumCoeff -
//     2,
//                               // inclusive.
...
//     // = 5, 9, or 13
//
//     // ctxIdxInc_coeff[i][levelListIdx=0] = ctxIdxInc for
//     significant_coeff_flag
//     // (frame coded macroblocks) ctxIdxInc_coeff[i][levelListIdx=1] =
//     ctxIdxInc
...
//   int32_t ctxIdxBlockCatOffset = ctxIdxBlockCatOffset_arr[ctxBlockCat];
//
//   // Let numDecodAbsLevelEq1 denote the accumulated number of decoded
//   transform
...
//   // related to the same transform coefficient block, where the current
//   decoding
...
//
//   // UEGk编码是由 prefix(TU binarization) + suffix(Exp-Golomb) +
//   signedValFlag,
//   // 三部分组成
//
//   //-----4.1. 先解码前缀(TU)--------
...
//
//     ret = DecodeBin(bs, bypassFlag, ctxIdx, binVal); // binIdx =
//     1,2,3,4.,..,k; RETURN_IF_FAILED(ret != 0, -1);
//   }
//
...
//   {
//     // synElVal为prefix(TU)的值 //synElVal consists only of a prefix bit
//     string
//   } else {
//     //注意：9.3.2.3 Concatenated unary/ k-th order Exp-Golomb (UEGk)
//     // binarization process 中的伪代码表示是UEGk的编码过程，解码需要逆向过来
...
//
//   //---------------注意是：FL, cMax=1------------------------
//   ctxIdx = ctxIdxOffset + 0;                       // ctxIdxOffset +
//   ctxIdxInc; ret = DecodeBin(bs, bypassFlag, ctxIdx, binVal); // binIdx = 0;
//   RETURN_IF_FAILED(ret != 0, -1);
//
//   // fixedLength = Ceil( Log2( cMax + 1 ) ) = Ceil( Log2( 1 + 1 ) ) = 1;
//   synElVal = binVal;
...
//                [i]) // all following transform coefficient levels (in
//                scanning
...
//          1 << (iCbCr + 1); // iCbCr=-1 --> luma, iCbCr=0 --> cb, iCbCr=1 -->
//          cr
//    } else                  // for AC
//    {
