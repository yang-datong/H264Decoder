...
int CH264Cabac::get_m_and_n(int32_t ctxIdx, H264_SLIECE_TYPE slice_type,
  ...
  // Table 9-16 – Values of variables m and n for ctxIdx from 54 to 59, and 399
  // to 401
  ...
  // Table 9-21 – Values of variables m and n for ctxIdx from 227 to 275
    ...
    const int8_t mn[4][49][2] = {
        ...
        {{-6, 76},  {-2, 44},   {0, 45},   {0, 52},    {-3, 64}, {-2, 59},
         ...
         {-8, 85}},
        {{-23, 112}, {-15, 71},  {-7, 61},  {0, 53},    {-5, 66},   {-11, 77},
         {-9, 80},   {-9, 84},   {-10, 87}, {-34, 127}, {-21, 101}, {-3, 39},
         {-5, 53},   {-7, 61},   {-11, 75}, {-15, 77},  {-17, 91},  {-25, 107},
         {-25, 111}, {-28, 122}, {-11, 76}, {-10, 44},  {-10, 52},  {-10, 57},
         {-9, 58},   {-16, 72},  {-7, 69},  {-4, 69},   {-5, 74},   {-9, 86},
         {2, 66},    {-9, 34},   {1, 32},   {11, 31},   {5, 52},    {-2, 55},
         {-2, 67},   {0, 73},    {-8, 89},  {3, 52},    {7, 4},     {10, 8},
         {17, 8},    {16, 19},   {3, 37},   {-1, 61},   {-5, 73},   {-1, 70},
         {-4, 78}},
        {{-24, 115}, {-22, 82},  {-9, 62},  {0, 53},    {0, 59},    {-14, 85},
         {-13, 89},  {-13, 94},  {-11, 92}, {-29, 127}, {-21, 100}, {-14, 57},
         {-12, 67},  {-11, 71},  {-10, 77}, {-21, 85},  {-16, 88},  {-23, 104},
         {-15, 98},  {-37, 127}, {-10, 82}, {-8, 48},   {-8, 61},   {-8, 66},
         {-7, 70},   {-14, 75},  {-10, 79}, {-9, 83},   {-12, 92},  {-18, 108},
         {-4, 79},   {-22, 69},  {-16, 75}, {-2, 58},   {1, 58},    {-13, 78},
         {-9, 83},   {-4, 81},   {-13, 99}, {-13, 81},  {-6, 38},   {-13, 62},
  ...
  // Table 9-22 – Values of variables m and n for ctxIdx from 277 to 337
    ...
    const int8_t mn[4][61][2] = {
        ...
        {{-13, 106}, {-16, 106}, {-10, 87},  {-21, 114}, {-18, 110}, {-14, 98},
         ...
         {4, 63},    {6, 64},    {-2, 69},   {-2, 59},   {6, 70},    {10, 44},
         {9, 31},    {12, 43},   {3, 53},    {14, 34},   {10, 38},   {-3, 52},
         {13, 40},   {17, 32},   {7, 44},    {7, 38},    {13, 50},   {10, 57},
         {26, 43}},
        {{-21, 126}, {-23, 124}, {-20, 110}, {-26, 126}, {-25, 124}, {-17, 105},
         ...
         {-2, 71},   {-2, 75},   {-1, 70},   {-9, 72},   {14, 60},   {16, 37},
         {0, 47},    {18, 35},   {11, 37},   {12, 41},   {10, 41},   {2, 48},
         {12, 41},   {13, 41},   {0, 59},    {3, 50},    {19, 40},   {3, 66},
         {18, 50}},
        {{-22, 127}, {-25, 127}, {-25, 120}, {-27, 127}, {-19, 114}, {-23, 117},
         ...
         {5, 60},    {2, 70},    {-2, 76},   {-18, 86},  {12, 70},   {5, 64},
         {-12, 70},  {11, 55},   {5, 56},    {0, 69},    {2, 65},    {-6, 74},
         {5, 54},    {7, 54},    {-6, 76},   {-11, 82},  {-2, 77},   {-2, 77},
         {25, 42}}};
  ...
  // Table 9-26 – Values of variables m and n for ctxIdx from 484 to 571
    ...
    const int8_t mn[4][88][2] = {
        ...
        {{-13, 103}, {-13, 91},  {-9, 89},   {-14, 92},  {-8, 76},   {-12, 87},
         ...
         {-5, 61},   {0, 58},    {-1, 60},   {-3, 61},   {-8, 67},   {-25, 84},
         {-14, 74},  {-5, 65},   {5, 52},    {2, 57},    {0, 61},    {-9, 69},
         {-11, 70},  {18, 55},   {-13, 103}, {-13, 91},  {-9, 89},   {-14, 92},
  ...
  // Table 9-27 – Values of variables m and n for ctxIdx from 572 to 659
    ...
    const int8_t mn[4][88][2] = {
        ...
        {{11, 28}, {2, 40},  {3, 44},  {0, 49},  {0, 46},  {2, 44},  {2, 51},
         ...
         {-1, 84}, {25, 7},  {30, -7}, {28, 3},  {28, 4},  {32, 0},  {34, -1},
         {30, 6},  {30, 6},  {32, 9},  {31, 19}, {26, 27}, {26, 30}, {37, 20},
         {28, 34}, {17, 70}, {11, 28}, {2, 40},  {3, 44},  {0, 49},  {0, 46},
         {2, 44},  {2, 51},  {0, 47},  {4, 39},  {2, 62},  {6, 46},  {0, 54},
         {3, 54},  {2, 58},  {4, 63},  {6, 51},  {6, 57},  {7, 53},  {6, 52},
         {6, 55},  {11, 45}, {14, 36}, {8, 53},  {-1, 82}, {7, 55},  {-3, 78},
         {15, 46}, {22, 31}, {-1, 84}, {25, 7},  {30, -7}, {28, 3},  {28, 4},
         {32, 0},  {34, -1}, {30, 6},  {30, 6},  {32, 9},  {31, 19}, {26, 27},
  ...
  // Table 9-33 – Values of variables m and n for ctxIdx from 1012 to 1023
    ...
    return -1; // ctxIdx = 276 is assigned to the binIdx of mb_type indicating
               // the I_PCM mode.
  } else {
...
int CH264Cabac::Initialisation_process_for_context_variables(
  ...
  // The possible values of the context index ctxIdx are in the range 0 to 1023,
  // inclusive.
...
// after the decoding of any pcm_alignment_zero_bit and all pcm_sample_luma and
