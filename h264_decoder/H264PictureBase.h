...
public:
  ...
  CH264MacroBlock *m_mbs; // 存储当前图像的所有宏块 m_mbs[PicSizeInMbs] =
...
public:
  ...
  int Initialisation_process_for_reference_picture_lists(
      CH264Picture *(&dpb)[16], CH264Picture *(&RefPicList0)[16],
      CH264Picture *(&RefPicList1)[16]); // 8.2.4.2
  ...
  int Modification_process_for_reference_picture_lists(
      CH264Picture *(&RefPicList0)[16],
      CH264Picture *(&RefPicList1)[16]); // 8.2.4.3 参考图像列表的重排序过程
  int Modification_process_of_reference_picture_lists_for_short_term_reference_pictures(
      ...
      CH264Picture *(&RefPicListX)[16]); // 8.2.4.3.1
  ...
  int Derivation_process_for_motion_vector_components_and_reference_indices(
      ...
      int32_t &predFlagL0, int32_t &predFlagL1, CH264PictureBase *&refPicL0,
      CH264PictureBase *&refPicL1); // 8.4.1
  ...
  int Derivation_process_for_the_co_located_4x4_sub_macroblock_partitions(
      int32_t mbPartIdx, int32_t subMbPartIdx, CH264PictureBase *&colPic,
  ...
  int Derivation_process_for_chroma_motion_vectors(
      int32_t ChromaArrayType, int32_t mvLX[2], CH264PictureBase *refPic,
  ...
  int Decoding_process_for_Inter_prediction_samples(
      ...
      int32_t (&mvCL1)[2], CH264PictureBase *refPicL0,
      CH264PictureBase *refPicL1, int32_t predFlagL0, int32_t predFlagL1,
  ...
  int Luma_sample_interpolation_process(
      ...
      CH264PictureBase *refPic, uint8_t &predPartLXL_xL_yL); // 8.4.2.2.1
  int Chroma_sample_interpolation_process(
      int32_t xIntC, int32_t yIntC, int32_t xFracC, int32_t yFracC,
      CH264PictureBase *refPic, int32_t isChromaCb,
  ...
  int Inverse_sub_macroblock_partition_scanning_process(CH264MacroBlock *mb,
                                                        int32_t mbPartIdx,
  ...
  int PicOrderCntFunc(
      CH264PictureBase *picX); // 8.2.1 POC: picture order count 图像序列号
