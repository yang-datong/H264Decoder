...
CH264SPSMVCExt::CH264SPSMVCExt() { memset(this, 0, sizeof(CH264SPSMVCExt)); }
...
int CH264SPSMVCExt::seq_parameter_set_mvc_extension(CBitstream &bs,
                                                    int profile_idc,
