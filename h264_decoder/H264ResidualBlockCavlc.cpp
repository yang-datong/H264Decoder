...
int CH264ResidualBlockCavlc::residual_block_cavlc(
    CH264PictureBase &picture, CBitstream &bs, int32_t *coeffLevel,
  ...
  uint16_t coeff_token = bs.getBits(
      16); // 先获取16bit数据（注意：并不是读取），因为coeff_token_table表里面最长的coeff_token为16bit，所以预先获取16bit数据就足够了
  ...
  uint16_t coeff_token2 = bs.readBits(
...
int CH264ResidualBlockCavlc::get_nC(CH264PictureBase &picture,
  ...
  if (mb_residual_level == MB_RESIDUAL_ChromaDCLevelCb ||
    ...
    if (mb_residual_level == MB_RESIDUAL_Intra16x16DCLevel ||
      ...
      RETURN_IF_FAILED(slice_header.m_sps.ChromaArrayType != 1 &&
                           slice_header.m_sps.ChromaArrayType != 2,
                       -1);
    ...
    if (availableFlagN_A == 1) {
      ...
      {
        nA = 16;
      } else // nN is set equal to the value TotalCoeff( coeff_token ) of the
             // neighbouring block blkN.
      {
        if (mb_residual_level == MB_RESIDUAL_Intra16x16DCLevel ||
            mb_residual_level == MB_RESIDUAL_Intra16x16ACLevel ||
            mb_residual_level == MB_RESIDUAL_LumaLevel4x4) {
...
// Table 9-5 – coeff_token mapping to TotalCoeff( coeff_token ) and
// TrailingOnes( coeff_token )
int CH264ResidualBlockCavlc::coeff_token_table(int32_t nC, uint16_t coeff_token,
                                               int32_t &coeff_token_bit_length,
                                               int32_t &TrailingOnes,
                                               int32_t &TotalCoeff) {
  if (nC >= 0 && nC < 2) {
    ...
    } else if ((coeff_token >> 11) == 0x0003) //(0001 1)b ==> (0 0011)b
    {
      ...
      TrailingOnes = 3;
      TotalCoeff = 3;
    } else if ((coeff_token >> 6) ==
               0x0007) //(0000 0001 11)b ==> (00 0000 0111)b
    {
    ...
    } else if ((coeff_token >> 10) == 0x0003) //(0000 11)b ==> (00 0011)b
    {
      ...
      TrailingOnes = 3;
      TotalCoeff = 4;
    } else if ((coeff_token >> 5) ==
               0x0007) //(0000 0000 111)b ==> (000 0000 0111)b
    {
      coeff_token_bit_length = 11;
      TrailingOnes = 0;
      TotalCoeff = 5;
    } else if ((coeff_token >> 6) ==
               0x0006) //(0000 0001 10)b ==> (00 0000 0110)b
    {
      coeff_token_bit_length = 10;
      TrailingOnes = 1;
      TotalCoeff = 5;
    ...
    } else if ((coeff_token >> 9) == 0x0004) //(0000 100)b ==> (000 0100)b
    {
      ...
      TrailingOnes = 3;
      TotalCoeff = 5;
    } else if ((coeff_token >> 3) ==
               0x000F) //(0000 0000 0111 1)b ==> (0 0000 0000 1111)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 0;
      TotalCoeff = 6;
    } else if ((coeff_token >> 5) ==
               0x0006) //(0000 0000 110)b ==> (000 0000 0110)b
    {
      coeff_token_bit_length = 11;
      TrailingOnes = 1;
      TotalCoeff = 6;
    } else if ((coeff_token >> 6) ==
               0x0005) //(0000 0001 01)b ==> (00 0000 0101)b
    {
      coeff_token_bit_length = 10;
      TrailingOnes = 2;
      TotalCoeff = 6;
    } else if ((coeff_token >> 8) == 0x0004) //(0000 0100)b ==> (0000 0100)b
    {
      ...
      TotalCoeff = 6;
               ...
               0x000B) //(0000 0000 0101 1)b ==> (0 0000 0000 1011)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 0;
      TotalCoeff = 7;
    } else if ((coeff_token >> 3) ==
               0x000E) //(0000 0000 0111 0)b ==> (0 0000 0000 1110)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 1;
      TotalCoeff = 7;
    } else if ((coeff_token >> 5) ==
               0x0005) //(0000 0000 101)b ==> (000 0000 0101)b
    {
      coeff_token_bit_length = 11;
      TrailingOnes = 2;
      TotalCoeff = 7;
    } else if ((coeff_token >> 7) == 0x0004) //(0000 0010 0)b ==> (0 0000 0100)b
    {
      ...
      TotalCoeff = 7;
               ...
               0x0008) //(0000 0000 0100 0)b ==> (0 0000 0000 1000)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 0;
      TotalCoeff = 8;
    } else if ((coeff_token >> 3) ==
               0x000A) //(0000 0000 0101 0)b ==> (0 0000 0000 1010)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 1;
      TotalCoeff = 8;
    } else if ((coeff_token >> 3) ==
               0x000D) //(0000 0000 0110 1)b ==> (0 0000 0000 1101)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 2;
      TotalCoeff = 8;
    } else if ((coeff_token >> 6) ==
               0x0004) //(0000 0001 00)b ==> (00 0000 0100)b
    {
      coeff_token_bit_length = 10;
      TrailingOnes = 3;
      TotalCoeff = 8;
    } else if ((coeff_token >> 2) ==
               0x000F) //(0000 0000 0011 11)b ==> (00 0000 0000 1111)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 0;
      TotalCoeff = 9;
    } else if ((coeff_token >> 2) ==
               0x000E) //(0000 0000 0011 10)b ==> (00 0000 0000 1110)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 1;
      TotalCoeff = 9;
    } else if ((coeff_token >> 3) ==
               0x0009) //(0000 0000 0100 1)b ==> (0 0000 0000 1001)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 2;
      TotalCoeff = 9;
    } else if ((coeff_token >> 5) ==
               0x0004) //(0000 0000 100)b ==> (000 0000 0100)b
    {
      coeff_token_bit_length = 11;
      TrailingOnes = 3;
      TotalCoeff = 9;
    } else if ((coeff_token >> 2) ==
               0x000B) //(0000 0000 0010 11)b ==> (00 0000 0000 1011)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 0;
      TotalCoeff = 10;
    } else if ((coeff_token >> 2) ==
               0x000A) //(0000 0000 0010 10)b ==> (00 0000 0000 1010)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 1;
      TotalCoeff = 10;
    } else if ((coeff_token >> 2) ==
               0x000D) //(0000 0000 0011 01)b ==> (00 0000 0000 1101)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 2;
      TotalCoeff = 10;
    } else if ((coeff_token >> 3) ==
               0x000C) //(0000 0000 0110 0)b ==> (0 0000 0000 1100)b
    {
      coeff_token_bit_length = 13;
      TrailingOnes = 3;
      TotalCoeff = 10;
    } else if ((coeff_token >> 1) ==
               0x000F) //(0000 0000 0001 111)b ==> (000 0000 0000 1111)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 0;
      TotalCoeff = 11;
    } else if ((coeff_token >> 1) ==
               0x000E) //(0000 0000 0001 110)b ==> (000 0000 0000 1110)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 1;
      TotalCoeff = 11;
    } else if ((coeff_token >> 2) ==
               0x0009) //(0000 0000 0010 01)b ==> (00 0000 0000 1001)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 2;
      TotalCoeff = 11;
    } else if ((coeff_token >> 2) ==
               0x000C) //(0000 0000 0011 00)b ==> (00 0000 0000 1100)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 3;
      TotalCoeff = 11;
    } else if ((coeff_token >> 1) ==
               0x000B) //(0000 0000 0001 011)b ==> (000 0000 0000 1011)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 0;
      TotalCoeff = 12;
    } else if ((coeff_token >> 1) ==
               0x000A) //(0000 0000 0001 010)b ==> (000 0000 0000 1010)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 1;
      TotalCoeff = 12;
    } else if ((coeff_token >> 1) ==
               0x000D) //(0000 0000 0001 101)b ==> (000 0000 0000 1101)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 2;
      TotalCoeff = 12;
    } else if ((coeff_token >> 2) ==
               0x0008) //(0000 0000 0010 00)b ==> (00 0000 0000 1000)b
    {
      coeff_token_bit_length = 14;
      TrailingOnes = 3;
      TotalCoeff = 12;
    } else if ((coeff_token >> 0) ==
               0x000F) //(0000 0000 0000 1111)b ==> (0000 0000 0000 1111)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 0;
      TotalCoeff = 13;
    } else if ((coeff_token >> 1) ==
               0x0001) //(0000 0000 0000 001)b ==> (000 0000 0000 0001)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 1;
      TotalCoeff = 13;
    } else if ((coeff_token >> 1) ==
               0x0009) //(0000 0000 0001 001)b ==> (000 0000 0000 1001)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 2;
      TotalCoeff = 13;
    } else if ((coeff_token >> 1) ==
               0x000C) //(0000 0000 0001 100)b ==> (000 0000 0000 1100)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 3;
      TotalCoeff = 13;
    } else if ((coeff_token >> 0) ==
               0x000B) //(0000 0000 0000 1011)b ==> (0000 0000 0000 1011)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 0;
      TotalCoeff = 14;
    } else if ((coeff_token >> 0) ==
               0x000E) //(0000 0000 0000 1110)b ==> (0000 0000 0000 1110)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 1;
      TotalCoeff = 14;
    } else if ((coeff_token >> 0) ==
               0x000D) //(0000 0000 0000 1101)b ==> (0000 0000 0000 1101)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 2;
      TotalCoeff = 14;
    } else if ((coeff_token >> 1) ==
               0x0008) //(0000 0000 0001 000)b ==> (000 0000 0000 1000)b
    {
      coeff_token_bit_length = 15;
      TrailingOnes = 3;
      TotalCoeff = 14;
    } else if ((coeff_token >> 0) ==
               0x0007) //(0000 0000 0000 0111)b ==> (0000 0000 0000 0111)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 0;
      TotalCoeff = 15;
    } else if ((coeff_token >> 0) ==
               0x000A) //(0000 0000 0000 1010)b ==> (0000 0000 0000 1010)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 1;
      TotalCoeff = 15;
    } else if ((coeff_token >> 0) ==
               0x0009) //(0000 0000 0000 1001)b ==> (0000 0000 0000 1001)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 2;
      TotalCoeff = 15;
    } else if ((coeff_token >> 0) ==
               0x000C) //(0000 0000 0000 1100)b ==> (0000 0000 0000 1100)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 3;
      TotalCoeff = 15;
    } else if ((coeff_token >> 0) ==
               0x0004) //(0000 0000 0000 0100)b ==> (0000 0000 0000 0100)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 0;
      TotalCoeff = 16;
    } else if ((coeff_token >> 0) ==
               0x0006) //(0000 0000 0000 0110)b ==> (0000 0000 0000 0110)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 1;
      TotalCoeff = 16;
    } else if ((coeff_token >> 0) ==
               0x0005) //(0000 0000 0000 0101)b ==> (0000 0000 0000 0101)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 2;
      TotalCoeff = 16;
    } else if ((coeff_token >> 0) ==
               0x0008) //(0000 0000 0000 1000)b ==> (0000 0000 0000 1000)b
    {
      coeff_token_bit_length = 16;
      TrailingOnes = 3;
      TotalCoeff = 16;
...
int CH264ResidualBlockCavlc::get_total_zeros(CBitstream &bs,
                                             int32_t maxNumCoeff,
                                             int32_t tzVlcIndex,
                                             int32_t &total_zeros) {
...
int CH264ResidualBlockCavlc::get_run_before(CBitstream &bs, int32_t zerosLeft,
                                            int32_t &run_before) {
  int32_t token = 0;
  int32_t token2 = 0;
  int32_t token_length = 0;
