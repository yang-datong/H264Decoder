...
CH264PicturesGOP::CH264PicturesGOP() { int ret = init(); }

CH264PicturesGOP::~CH264PicturesGOP() { int ret = unInit(); }
...
int CH264PicturesGOP::getOneEmptyPicture(Nalu *&pic) {
  int ret = 0;
  int32_t size_dpb = H264_MAX_DECODED_PICTURE_BUFFER_COUNT;
...
int CH264PicturesGOP::getOneOutPicture(Nalu *newDecodedPic, Nalu *&outPic) {
  int32_t i = 0;
  int32_t index = -1;
