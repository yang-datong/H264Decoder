...
int CH264SliceHeader::printInfo() {
  ...
  //    modification_of_pic_nums_idc); printf("abs_diff_pic_num_minus1=%d;\n",
...
int CH264SliceHeader::slice_header(BitStream &bs, const CH264NalUnit &nal_unit,
  ...
  if (m_nal_unit.nal_unit_type == 20 || m_nal_unit.nal_unit_type == 21) {
    ...
    printf("Unsupported m_nal_unit.nal_unit_type == 20 || "
...
int CH264SliceHeader::pred_weight_table(BitStream &bs) {
  ...
  for (i = 0; i <= num_ref_idx_l0_active_minus1; i++) {
    ...
    if (m_sps.ChromaArrayType != 0) {
      chroma_weight_l0[i][0] =
          1 << chroma_log2_weight_denom; // When chroma_weight_l0_flag is equal
                                         // to 0
  ...
  if (slice_type % 5 == 1) {
    for (i = 0; i <= num_ref_idx_l1_active_minus1; i++) {
      luma_weight_l1[i] =
          1 << luma_log2_weight_denom; // When luma_weight_l1_flag is equal to 0
