#ifndef H264PICTURE_HPP_CITBIZD4
#define H264PICTURE_HPP_CITBIZD4
...
//  H264_PICTURE_CODED_TYPE_FRAME H264_PICTURE_CODED_TYPE
//  m_picture_coded_type_marked_as_refrence;
//  //整个帧或哪一场被标记为参考帧或参考场
//
...
//  0-未解码完毕，1-已经解码完毕 int32_t m_is_in_use; //本帧数据是否正在使用;
//  0-未使用，1-正在使用
//
// public:
//  CH264Picture();
...
//  int reset();
//
//  int decode_one_slice(CH264SliceHeader &slice_header, CBitstream &bs,
//                       CH264Picture *(&dpb)[16]);
//  CH264Picture &operator=(const CH264Picture &src);
//  int copyPicture(const CH264Picture &src);
//};
//
#endif /* end of include guard: H264PICTURE_HPP_CITBIZD4 */
