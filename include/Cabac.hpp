...
//
//   int Initialisation_process_for_context_variables(H264_SLIECE_TYPE
//   slice_type,
...
//       PictureBase &picture, int32_t ctxBlockCat, int32_t BlkIdx, int32_t
//       iCbCr, int32_t &ctxIdxInc); // 9.3.3.1.1.9
//   int
...
//                                        int32_t ctxIdxOffset, int32_t
//                                        &synElVal);
//   int CABAC_decode_mb_type_in_SI_slices(PictureBase &picture, BitStream &bs,
//                                         int32_t &synElVal);
//   int CABAC_decode_mb_type_in_P_SP_slices(PictureBase &picture, BitStream
//   &bs,
//                                           int32_t &synElVal);
...
//                                               BitStream &bs, int32_t
//                                               &synElVal);
//   int CABAC_decode_sub_mb_type_in_B_slices(PictureBase &picture, BitStream
//   &bs,
//                                            int32_t &synElVal);
//
//   int CABAC_decode_mb_skip_flag(PictureBase &picture, BitStream &bs,
//                                 int32_t _CurrMbAddr, int32_t &synElVal);
//   int CABAC_decode_mvd_lX(PictureBase &picture, BitStream &bs, int32_t
//   mvd_flag,
...
//                                int32_t &synElVal);
//   int CABAC_decode_intra_chroma_pred_mode(PictureBase &picture, BitStream
//   &bs,
//                                           int32_t &synElVal);
//   int
...
//       PictureBase &picture, BitStream &bs, int32_t &synElVal);
//   int CABAC_decode_mb_field_decoding_flag(PictureBase &picture, BitStream
//   &bs,
//                                           int32_t &synElVal);
...
//                                      int32_t &synElVal);
//   int CABAC_decode_transform_size_8x8_flag(PictureBase &picture, BitStream
//   &bs,
//                                            int32_t &synElVal);
//
//   //------------------------------------
