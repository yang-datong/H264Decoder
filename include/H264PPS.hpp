...
#define H264_MAX_PPS_COUNT                                                     \
  256 // 7.4.2.2: pic_parameter_set_id shall be in the range of 0 to 255,
      // inclusive.
...
class CH264PPS {
 public:
  ...
  int32_t slice_group_map_type; // 1 ue(v)    [A.2.1 Baseline profile]
                                // num_slice_groups_minus1 in the range of 0 to
                                // 7, inclusive.
 ...
 public:
  ...
  int pic_parameter_set_rbsp(BitStream &bs, CH264SPS (&m_spss)[32]);
};
