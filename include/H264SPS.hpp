...
class CH264SPS {
 public:
  ...
  int32_t bit_depth_luma_minus8; // 0 ue(v) When bit_depth_luma_minus8 is not
                                 // present, it shall be inferred to be equal to
                                 // 0. bit_depth_luma_minus8 shall be in the
  ...
  int32_t seq_scaling_list_present_flag[12]; // seq_scaling_list_present_flag[ i
                                             // ] 0 u(1)
  ...
  int32_t FrameHeightInMbs; // FrameHeightInMbs = ( 2 - frame_mbs_only_flag ) *
                            // PicHeightInMapUnits;
  int32_t PicHeightInMapUnits; // PicHeightInMapUnits =
                               // pic_height_in_map_units_minus1 + 1;
  int32_t PicSizeInMapUnits;   // PicSizeInMapUnits = PicWidthInMbs *
                               // PicHeightInMapUnits;
  ...
  int32_t RawMbBits; // RawMbBits = 256 * BitDepthY + 2 * MbWidthC * MbHeightC *
                     // BitDepthC;
 ...
 public:
  ...
  int seq_parameter_set_data(BitStream &bs);
