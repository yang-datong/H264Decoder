#include "H264Picture.hpp"

// CH264Picture::CH264Picture() { int ret = init(); }
//
// CH264Picture::~CH264Picture() { int ret = m_picture_frame.unInit(); }
//
...
//   this->m_picture_coded_type_marked_as_refrence =
//       src.m_picture_coded_type_marked_as_refrence;
//
...
// }
//
// int CH264Picture::decode_one_slice(CH264SliceHeader &slice_header,
//                                    CBitstream &bs, CH264Picture *(&dpb)[16])
//                                    {
//   int ret = 0;
//   int32_t size_pdb = 16;
//   int32_t i = 0;
...
//
//   //----------------顶场-------------------------------
//   m_picture_top_filed.m_picture_coded_type =
//   H264_PICTURE_CODED_TYPE_TOP_FIELD; m_picture_top_filed.m_parent = this;
//
...
//   {
//     ret = m_picture_frame.m_h264_slice_data.slice_data(bs, m_picture_frame,
//                                                        slice_header.slice_id);
//     RETURN_IF_FAILED(ret != 0, ret);
...
//
//       ret = m_picture_top_filed.m_h264_slice_data.slice_data(
//           bs, m_picture_top_filed, slice_header.slice_id);
//       RETURN_IF_FAILED(ret != 0, ret);
//     } else // if (slice_header.bottom_field_flag == 1) //底场
//     {
//       m_current_picture_ptr = &m_picture_bottom_filed;
//
//       ret = m_picture_bottom_filed.m_h264_slice_data.slice_data(
//           bs, m_picture_bottom_filed, slice_header.slice_id);
//       RETURN_IF_FAILED(ret != 0, ret);
//     }
//   }
//
